...
myfun<-function(f,s=0.1,aM=0.1,aN=0.2,phi=5){
...
s<-0.1
fmin<-(s*bmax)/(bmax-d)
myfmax<-uniroot(myfun, interval=c(fmin,0.9), s=s, aM=0.1, aN=0.1, phi=5) #fmax=0.3146655
fmax<-myfmax$root
cat("range of fidelity for coexistence: (fmin,fmax)=(",fmin,",",fmax,")\n")
(fmax-fmin)
...
s<-0
fmin<-(s*bmax)/(bmax-d)
myfmax<-uniroot(myfun, interval=c(fmin,0.9), s=s, aM=0.1, aN=0.2, phi=5) #fmax=0.2103166
fmax<-myfmax$root
cat("range of fidelity for coexistence: (fmin,fmax)=(",fmin,",",fmax,")\n")
(fmax-fmin)
...
while(s<=smax){
  ...
  myfmax<-uniroot(myfun, interval=c(fmin+0.0001,0.999), s=s, aM=0.1, aN=0.2, phi=5) 
  fmax_phi5<-myfmax$root
  fmaxs_phi5_aM_0.1_aN_0.2<-c(fmaxs_phi5_aM_0.1_aN_0.2,fmax_phi5)
  
  myfmax<-uniroot(myfun, interval=c(fmin+0.0001,0.999), s=s, aM=0.1, aN=0.2, phi=1) 
...
#  if(s>0){
    ...
    myfmax<-uniroot(myfun, interval=c(fmin+0.001,0.9), s=s, aM=0.1, aN=0.1, phi=5) 
    fmax_phi5<-myfmax$root
    fmaxs_phi5_aM_0.1_aN_0.1<-c(fmaxs_phi5_aM_0.1_aN_0.1,fmax_phi5)
    
    myfmax<-uniroot(myfun, interval=c(fmin+0.001,0.9), s=s, aM=0.1, aN=0.1, phi=1) 
    fmax_phi1<-myfmax$root
