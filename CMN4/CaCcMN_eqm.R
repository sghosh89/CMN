...
#-----------------
pdf("./Results/pdf_fig/Ca_eqm_vs_f_km_10_kn_10.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Caeq,type="b",xlab="f",ylab=expression(hat(C[a])),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Caeq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
dev.off()

pdf("./Results/pdf_fig/Cc_eqm_vs_f_km_10_kn_10.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Cceq,type="b",xlab="f",ylab=expression(hat(C[c])),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Cceq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
dev.off()

pdf("./Results/pdf_fig/M_eqm_vs_f_km_10_kn_10.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Meq,type="b",xlab="f",ylab=expression(hat(M)),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Meq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
dev.off()

pdf("./Results/pdf_fig/N_eqm_vs_f_km_10_kn_10.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Neq,type="b",xlab="f",ylab=expression(hat(N)),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Neq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
dev.off()

pdf("./Results/pdf_fig/M_PM_eqm_vs_f_km_10_kn_10.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Meq,xlab="f",lwd=2,type="l",ylab="",cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Meq)),col="red")
abline(h=1,col="grey",lwd=2)
lines(df$f,df$pMNeq,lty="dashed",lwd=2)

legend("topright", c(expression(hat(M)),expression(hat(P[m]))), 
       cex = 2.5, lty = c(1, 2), lwd=c(2,2), col=c("red","black"), 
       xpd = TRUE, horiz = F, inset = c(0,0),y.intersp = 1.2,x.intersp = 0.2,
       bty = "n")
...
#-----------------
pdf("./Results/pdf_fig/Ca_eqm_vs_f_km_10_kn_6.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Caeq,type="b",xlab="f",ylab=expression(hat(C[a])),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Caeq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
...
pdf("./Results/pdf_fig/Cc_eqm_vs_f_km_10_kn_6.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Cceq,type="b",xlab="f",ylab=expression(hat(C[c])),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Cceq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
...
pdf("./Results/pdf_fig/M_eqm_vs_f_km_10_kn_6.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Meq,type="b",xlab="f",ylab=expression(hat(M)),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Meq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
...
pdf("./Results/pdf_fig/N_eqm_vs_f_km_10_kn_6.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Neq,type="b",xlab="f",ylab=expression(hat(N)),cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Neq)),lwd=2)
abline(h=0,col="grey",lwd=2)
par(op)
...
pdf("./Results/pdf_fig/M_PM_eqm_vs_f_km_10_kn_6.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$f,df$Meq,xlab="f",lwd=2,type="l",ylab="",cex.lab=2.5,cex.axis=2,ylim=c(0,max(df$Meq)),col="red")
abline(h=1,col="grey",lwd=2)
lines(df$f,df$pMNeq,lty="dashed",lwd=2)
...
pdf("./Results/pdf_fig/MN_eqm_vs_ps_km_10_kn_10_f_0.3.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
...
pdf("./Results/pdf_fig/M_PM_eqm_vs_ps_km_10_kn_10_f_0.3.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$ps,df$Meq,xlab=expression(P[s]),lwd=2,type="l",ylab="",cex.lab=2.5,cex.axis=2,ylim=c(0,3),col="red")
abline(h=0,col="grey",lwd=2)
lines(df$ps,df$pMNeq,lty="dashed",lwd=2)
...
#---------when km and kn are not equal and f=0.7---------------------
...
pdf("./Results/pdf_fig/MN_eqm_vs_ps_km_10_kn_6_f_0.7.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
ylm<-max(df$Meq,df$Neq,na.rm = T)
plot(df$ps,df$Meq,type="l",xlab=expression(P[s]),ylab="",
     cex.lab=2.5,cex.axis=2,lwd=2,
...
pdf("./Results/pdf_fig/M_PM_eqm_vs_ps_km_10_kn_6_f_0.7.pdf",width=8,height=8)
op<-par(mar=c(6,6.2,2,2))
plot(df$ps,df$Meq,xlab=expression(P[s]),lwd=2,type="l",ylab="",cex.lab=2.5,cex.axis=2,ylim=c(0,3),col="red")
abline(h=0,col="grey",lwd=2)
lines(df$ps,df$pMNeq,lty="dashed",lwd=2)
